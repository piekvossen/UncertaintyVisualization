/**
 * A concrete implementation of a force directed graph
 *
 ...
 * var forceDirectedGraph1 = dc.forceDirectedGraph('#chart-container1');
 * // create a bubble chart under #chart-container2 element using chart group A
 * var forceDirectedGraph2 = dc.forceDirectedGraph('#chart-container2', 'chartGroupA');
 * @param {String|node|d3.selection} parent - Any valid
 * {@link https://github.com/mbostock/d3/wiki/Selections#selecting-elements d3 single selector} specifying
 * a dom block element such as a div; or a dom element or d3 selection.
 * @param {String} [chartGroup] - The name of the chart group this chart instance should be placed in.
 * Interaction with a chart will only trigger events and redraws within the chart's group.
 * @return {dc.forceDirectedGraph}
 */
dc.forceDirectedGraph = function(parent, chartGroup) {
   ...
   * @name elasticRadius
   * @memberof dc.forceDirectedGraph
   * @instance
